...
import { loadCodexProToolManifest } from "../codexpro/tool-manifest.js";
...
const codexProTools = await loadCodexProToolManifest(config.workspaceRoot, config.codexProToolMode);
